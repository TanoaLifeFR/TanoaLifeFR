...
_role1 = "Bienvenue sur le Serveur Elysium RP";
_role1names = ["Server only FR"];
_role2 = "Site/Forum";
_role2names = ["A venir"];
_role3 = "TeamSpeak3";
_role3names = ["Ts15.niTraDo.neT:21600"];
_role4 = "Attention";
_role4names = ["Vous devez avoir lu obligatoirement les règles du serveur avant d'attaquer à jouer"];
_role5 = "Pour tous problèmes";
_role5names = ["Si vous rencontrez tout problème avec un joueur ou bug, merci de vous référer au TeamSpeak ou Forum d'Elysium! Bon jeu!];

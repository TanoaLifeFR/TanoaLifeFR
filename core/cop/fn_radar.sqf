...
if(count _cars < 2) exitWith{hint parseText format ["<t color='#5A80EB'><t align='center'><t size='1.5'>ERREUR !</t></t><br/><t color='#FF0000'><t size='1'>Pas de véhicule a porter de vue !</t></t>"];};
_vehicle = (_cars select 1);
_type = getText(configFile >> "CfgVehicles" >> (typeOf _vehicle) >> "displayName");
if(count (crew (_vehicle)) == 0) exitWith {hint parseText format ["<t color='#5A80EB'><t align='center'><t size='1.5'>ERREUR !</t></t><br/><t color='#FF0000'><t size='1'>Le véhicule n'est pas en mouvement !</t></t>"];};

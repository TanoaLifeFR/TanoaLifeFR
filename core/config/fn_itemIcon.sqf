...
switch (_var) do
{
	...
	case "life_inv_rabbit": {("icons\items\kebab.paa")};
	...
	case "life_inv_charbon": {("icons\items\charbon.paa")};
	case "life_inv_charbonr": {("icons\items\charbonr.paa")};
	case "life_inv_argent": {("icons\items\argent.paa")};

...
switch (_mode) do
{
	case 0:
	{
		switch (_var) do
		{
			...
			case "argentr": {"life_inv_argentr"};
			case "charbon": {"life_inv_charbon"};
			case "charbonr": {"life_inv_charbonr"};
			...
			case "plutoniumore": {"life_inv_plutoniumore"};
	...
	case 1:
	{
		switch (_var) do
		{
			...
			case "life_inv_argentr": {"argentr"};
			case "life_inv_charbon": {"charbon"};
			case "life_inv_charbonr": {"charbonr"};
			...
			case "life_inv_plutoniumore": {"plutoniumore"};

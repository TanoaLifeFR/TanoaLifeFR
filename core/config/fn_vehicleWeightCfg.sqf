...
switch (_className) do
{
	...
	case "O_G_Offroad_01_F": {70};
	case "B_Quadbike_01_F": {40};
	case "O_G_Quadbike_01_F": {40};
	case "I_Truck_02_covered_F": {250};
	case "O_Truck_02_Ammo_F": {250};
	...
	case "C_Van_01_fuel_F": {125};
	case "C_Boat_Civil_01_F": {85};
	case "C_Boat_Civil_01_police_F": {85};
	case "C_Boat_Civil_01_rescue_F": {85};
	case "B_Truck_01_mover_F": {300};
	case "B_Truck_01_transport_F": {350};
	case "B_Truck_01_covered_F": {400};
	case "B_Truck_01_box_F": {525};
	case "B_MRAP_01_F": {65};
	case "O_MRAP_02_F": {60};
	case "I_MRAP_03_F": {58};
	case "B_Heli_Light_01_F": {90};
	case "B_Heli_Light_01_stripped_F": {90};
	case "C_Heli_Light_01_civil_F": {110};
	case "O_Heli_Light_02_unarmed_F": {150};
	case "I_Heli_Transport_02_F": {350};
	case "O_Heli_Transport_04_box_F": {500};
	case "O_Heli_Transport_04_covered_F": {400};
	case "O_Heli_Transport_04_bench_F": {350};
	case "O_Heli_Transport_04_F": {375};

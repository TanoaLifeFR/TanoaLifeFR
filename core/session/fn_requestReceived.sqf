...
switch(playerSide) do {
	...
	{
		case "licence_civ_dona1":{life_paycheck = life_paycheck + 150;};
		case "licence_civ_dona2":{life_paycheck = life_paycheck + 300;};
		case "licence_civ_dona3":{life_paycheck = life_paycheck + 450;};
		case "licence_civ_dona4":{life_paycheck = life_paycheck + 600;};
	};
